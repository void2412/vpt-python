...
# Form implementation generated from reading ui file 'autotrain.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(180, 60, 84, 51))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.boxRadioButton = QtWidgets.QRadioButton(self.verticalLayoutWidget_3)
        self.boxRadioButton.setObjectName("boxRadioButton")
        self.verticalLayout_3.addWidget(self.boxRadioButton)
        self.chatRadioButton = QtWidgets.QRadioButton(self.verticalLayoutWidget_3)
        self.chatRadioButton.setObjectName("chatRadioButton")
        self.verticalLayout_3.addWidget(self.chatRadioButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "auto train"))
        self.label_2.setText(_translate("MainWindow", "delay(ms)"))
        self.label.setText(_translate("MainWindow", "window title"))
        self.startBtn.setText(_translate("MainWindow", "start"))
        self.boxRadioButton.setText(_translate("MainWindow", "RadioButton"))
        self.chatRadioButton.setText(_translate("MainWindow", "RadioButton"))
